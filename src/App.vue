<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      ...
      <p class="text-center my-10 text-5xl font-extrabold text-lime-500">{{ formatearDinero(cantidad) }}</p>
    ...
    <div v-if="total > 0" class="my-5 space-y-3 bg-gray-50 p-5">
      ...
      <p class="text-xl text-gray-500 text-center font-bold">Total a pagas: {{formatearDinero(total)}}</p>
...
//definicion del state de nuestra App
...
// funciones para manejar el evento
...
// otra forma de definir el estado en vue/compositionApi
